...
function SignupFlow() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#f8f9ff", fontFamily: "'Inter', sans-serif" }}>
      {/* ── Preview badge — this route is /signup-preview, an
          experimental sandbox for iterating on onboarding copy /
          layout without touching /signup. Real signups still go to
          /signup. Remove this block + delete the /signup-preview
          folder to retire the sandbox. */}
      <div className="w-full text-center py-2 text-xs font-bold uppercase tracking-widest text-white" style={{ background: "#c026d3" }}>
        PREVIEW MODE · /signup-preview · not the live signup
      </div>
      {/* ── Header ── */}
