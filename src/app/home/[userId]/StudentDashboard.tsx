                    ...
                    <div className="relative z-10 flex">
                      ...
                      <div className="w-36 flex items-center justify-center p-4">
                        {(() => {
                          ...
                          return (
                            <div className="w-28 h-28 rounded-2xl border-2 border-white/20 overflow-hidden bg-transparent flex items-center justify-center">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-24 shrink-0 flex items-center justify-center">
                        {(() => {
                          ...
                          return (
                            <div className="w-20 h-20 rounded-xl border-2 border-white/20 overflow-hidden bg-transparent flex items-center justify-center">
                              <video src={videoSrc} autoPlay loop muted playsInline className="w-full h-full object-contain" style={{ mixBlendMode: "multiply" }} />
                            </div>
                          );
                        })()}
