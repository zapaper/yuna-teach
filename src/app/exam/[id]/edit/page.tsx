...
function ExamEditContent({ id }: { id: string }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {paper.metadata?.fallbackModelUsed && (
        <div className="lg:ml-56 px-6 pt-4">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3 max-w-2xl mx-auto">
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 mt-1">The primary model was unavailable due to high demand. A backup model ({paper.metadata.fallbackModelUsed}) was used instead. Results may be less accurate — please review carefully and re-extract if needed.</p>
            </div>
          </div>
        </div>
      )}
