    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:ml-56 pb-24 lg:pb-0">
        <div className="bg-white border-b border-slate-200 px-4 py-3">
          ...
          {/* Language toggle — large segmented pill right under the
              title. Active side is filled indigo; inactive side is a
              link to the sibling module carrying userId. */}
          <div className="mt-2 inline-flex rounded-xl bg-slate-100 p-1 ring-1 ring-slate-200">
            <span className="px-5 py-2 rounded-lg text-sm font-bold bg-indigo-600 text-white shadow-sm">English</span>
            <Link
