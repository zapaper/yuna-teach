...
function SolverContent() {
  ...
  async function handleShare() {
    ...
    try {
      ...
      ctx.fillText("Practice with similar questions. FREE", W / 2, logoY + 64);
          ...
          <div className="space-y-4 pt-4">
            ...
            {diagrams.length > 0 && (
              <div className="rounded-2xl bg-white border border-slate-100 p-4 space-y-4">
                ...
                {diagrams.map((d: DiagramStep, i: number) => (
                  <div key={i}>
...
// BarDiagram + DiagramStep moved to src/components/BarDiagram.tsx
// so the AI explainer can reuse the same render.
