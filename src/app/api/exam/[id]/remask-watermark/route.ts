...
// paper. Every page gets the bottom-right scrub; page 0 ALSO gets a top-left
// scrub since scanner apps stamp a small icon / login email there on the
// first page only. Question crops are NOT touched — they're assumed to
// already exclude the watermark region at extraction time.
