...
**先数清楚学生用了多少个成语 / 好词好句 / 生动描写**，然后照此表给分:

| 成语 / 好句使用情况 | 词汇分**下限** (即必须给到) |
|---|---|
| 6+ 个成语**切合情境** + 多处生动描写 | **9 分** (满分 10) |
| 4-5 个成语切合情境 + 一些描写 | **8 分** |
| 2-3 个成语，描写一般 | **7 分** |
| 1 个或没有成语，全是简单常用词 | **5-6 分** |

**这是下限，不是上限**。即使有 1-2 处词语搭配不当 (例如 "捞出勇气" 应是 "鼓起勇气")，**也不能跌破上面的下限**。词语搭配的错误最多扣 0.5 分，因为这是真正的词汇问题；但前提是已经按下限给分。
