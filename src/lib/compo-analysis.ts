...
- 23-27 分: 中等 / 大部分学生 (清晰但不亮眼)
- 28-32 分: 良好 / 平均偏上 (情节顺畅、用词正确、有一些好句)
- 33-35 分: 优秀 / 上四分之一 (情节有起伏、用了一些成语和好句、描写生动)
- 36-38 分: 接近满分 / 上 5%
- 39-40 分: 极少数顶尖学生

下面的范文都是 40/40 的极少数顶尖作品。**不要用它们当 "及格线"**。一篇情节通顺、用词正确的小学高年级作文就值得 28-32 分。33+ 才需要看到成语 / 好句 / 描写。
**不要因为 "可以更好" 就扣分** — 只在真有缺陷的地方扣。
...
【真实分数分布 — 校准】
- 23-27 分: 中等。28-32 分: 良好。33-35 分: 优秀 (有成语 + 好句 + 描写)。
- 36-38 分: 接近满分。39-40 分: 极少数顶尖。
