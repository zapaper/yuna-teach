...
const DAVID_ENGLISH_COMBOS: LumiEnglishQuizCombo[] = [
  {
    ...
    topicRecap: {
      ...
      watchOut: [
        "Pronouns: pick the form by the ROLE the pronoun plays in the sentence. WHO is for the doer — 'the boy WHO is running'. WHOM is for the receiver of an action — 'the boy WHOM I called' (a quick check: if you can swap in 'him' or 'her', the word should be WHOM). WHOSE shows possession — 'the boy WHOSE bag is missing'. Reflexive pronouns (himself / herself / themselves) only work when the subject and object of the action are the SAME person — 'Mr Loh smiled at HIMSELF' (Mr Loh is doing the smiling AND being smiled at). If a different person receives the action, use the regular pronoun (him / her).",
        "Tag questions: the short check at the end of a statement ('isn't he?', 'shall we?'). Two moves every time: mirror the main verb or auxiliary, then flip the polarity. 'She IS happy' → 'isn't she?' (mirror IS, flip positive to negative). 'He DIDN'T finish' → 'did he?' (mirror DID, flip negative to positive). The biggest trap is negative-meaning words like NEVER, HARDLY, SELDOM, RARELY, BARELY — they make the statement negative even without the word NOT, so the tag must go POSITIVE: 'She NEVER visits, DOES she?' (not 'doesn't she'). Memorise two irregulars: 'Let's…' always pairs with 'shall we?', and 'I am' pairs with 'aren't I?'.",
        "Countable / uncountable: pick the quantifier by asking 'can I count this noun?'. Countable nouns (books, ideas, students) take FEW, MANY, SEVERAL, A NUMBER OF, FEWER. Uncountable nouns (water, advice, luck, news, information, equipment, furniture, luggage) take LITTLE, MUCH, A GREAT DEAL OF, LESS. The trap: mass nouns that LOOK plural but aren't — NEWS, LUGGAGE, INFORMATION, EQUIPMENT all use 'little' / 'much', never 'few' / 'many'. Another classic: 'A number of pupils ARE absent' (plural verb) vs 'THE number of pupils IS rising' (singular verb) — same words, different verbs, watch the article.",
      ],
    },
  },
  {
