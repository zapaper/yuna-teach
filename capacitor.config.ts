...
const config: CapacitorConfig = {
  ...
  plugins: {
    ...
    // Google + Apple native sign-in is configured at runtime via
    // SocialLogin.initialize() in src/lib/native-auth.ts — see
    // commit history for the rationale. No capacitor.config.ts
    // block needed here.
  },
};
