...
const SLUGS = ["grammar-mcq-1", "grammar-mcq-2", "chinese-mcq-1", "chinese-oeq-setpieces", "chinese-idioms", "chinese-sentence-completion", "chinese-cloze", "chinese-comprehension"];
