// Render every page of the P5 Chinese spelling-list PDF to a JPG.

import { renderPdfToJpegs } from "../src/lib/pdf-server";
import * as fs from "fs";
import * as path from "path";

const PDF = "C:/Users/peter/Yuna teach/Data Past Year Papers/PSLE Chinese/P5 Chinese spelling list.pdf";
const OUT_DIR = path.join(__dirname, "p5-spelling-list-pages");
